          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="nav nav-underline">
              <li className="nav-item">
                <Link to={"/search"} className="nav-link ms-5 p-0">Home</Link>
              </li>
              <li className="nav-item">
          ...
          <div className="modal-body">
            ...
            <nav className="navbar">
              <div className="container-fluid d-flex justify-content-center">
                <a className="navbar-brand" href="#">Change Profile picture</a>
              </div>
            </nav>
            <div className="mb-3">
            ...
            <button type="submit" className="btn btn-warning text-white col-12">
              Update Profile
            </button>
          </div>
        </div>
